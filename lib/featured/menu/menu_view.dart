...
class _MenuViewState extends ConsumerState<MenuView> {
                                                              ...
                                                              onPressed: () async {
                                                                ...
                                                                final shouldDelete = await showDialog<bool>(
                                                                  ...
                                                                  builder: (context) => AlertDialog(
                                                                    ...
                                                                    content: Text(
                                                                      'Bu kategori ve kategoriye bağlı tüm ürünler silinecek. Emin misiniz?',
                                                                      style: GoogleFonts.poppins(),
                                                                    ),
                                                                    actions: [
                                                                      TextButton(
                                                                ...
                                                                if (shouldDelete == true) {
                                                                  ...
                                                                  await menuNotifier.deleteCategory(category, context);
                                                              ...
                                                              children: [
                                                                ...
                                                                ElevatedButton(
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    await menuNotifier.updateCategory(
                                                                      updatedCategory,
                                                                      category.title ?? '',
                                                                      context,
                                                                    );
  ...
  Future<void> _addProductDialog(BuildContext context, bool isUploading,
